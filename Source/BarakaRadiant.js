 ...
 BarakaRadiant = {
    ...
    BarakaModal: function() {
        ...
        var makeDiv = function(self, modal) {
          var fakediv = document.getElementById('BarakaModal_temp');
          if (fakediv === null) {
            var div = document.createElement('div');
            div.id = 'BarakaModal_temp';
        ...
        var moveTrig = function(trig, modal, div) {
          ...
          var m = modal;
          var mProps = m.querySelector('.BarakaModal_content').getBoundingClientRect();
          var transX, transY, scaleX, scaleY;
          var xc = w.innerWidth / 2;
          var yc = w.innerHeight / 2;

          trig.classList.add('BarakaModal_trigger-active');
          ...
          if (m.classList.contains('BarakaModal-align-top')) {
        ...
        var open = function(m, div) {
          if(document.getElementsByClassName('BarakaMaterial-box--show').length) {
             document.getElementById('BarakaMaterial').click();
          }
          if (!isOpen) {
            var content = m.querySelector('.BarakaModal_content');
            m.classList.add('BarakaModal-active');
            content.classList.add('BarakaModal_content-active');
        ...
        var close = function(event) {
          ...
          var div = document.getElementById('BarakaModal_temp');
          if (isOpen && target.classList.contains('BarakaModal_bg') || target.classList.contains('BarakaModal_close')) {
            div.style.opacity = '1';
            div.removeAttribute('style');
            for (var i = 0; i < len; i++) {
              barakarpm[i].classList.remove('BarakaModal-active');
              content[i].classList.remove('BarakaModal_content-active');
              trigger[i].style.transform = 'none';
              trigger[i].style.webkitTransform = 'none';
              trigger[i].classList.remove('BarakaModal_trigger-active');
            }
        ...
        var bindActions = function() {
          for (var i = 0; i < len; i++) {
            ...
            barakarpmbg[i].addEventListener('click', close, false);
          }
        };
      return bindActions();
    }
